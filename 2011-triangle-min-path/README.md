...
and as part of the popular publicly-available *4clojure* problems (see
[Problem 79, Triangle Minimal Path](https://4clojure.oxal.org/#/problem/79)).
So please consider this code repository to be a Java 7 solution to those specific publicly-available
coding problems.
